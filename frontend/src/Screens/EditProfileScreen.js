							...
							<div
								...
								<div className='modal-content bg-dark'>
									...
									<div className='modal-body'>
										<button
											className={`${
												posi === 'top' ? 'btn-primary' : 'btn-outline-primary'
										...
										<button
											className={`${
												posi === 'right' ? 'btn-primary' : 'btn-outline-primary'
											} btn btn-block  w-100 m-1 h3 option`}
											onClick={() => {
												setPosi('right')
											}}>
										...
										<button
											className={`${
												posi === 'left' ? 'btn-primary' : 'btn-outline-primary'
											} btn btn-block  w-100 m-1 h3 option`}
											onClick={() => {
												setPosi('left')
											}}>
								...
								<div
									...
									style={{
										backgroundImage: `url(uploads/${
											coverPhoto && coverPhoto.split('uploads')[1]
										})`,
